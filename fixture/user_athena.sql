-- Code generated by "athena_schema -type User,Post,HttpLog ./fixture/"; DO NOT EDIT
...
CREATE EXTERNAL TABLE IF NOT EXISTS `http_log` (
  `request_parameter` struct<method: string, url: string, http_header: , request_body: string, query_parameter: string>,
  `response,omitempty` struct<status_code: int, http_header: , response_body: string>
) PARTITIONED BY (
  `year` int,
  `month` int,
  `day` int
